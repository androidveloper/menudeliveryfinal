...
class TipomenusControllerTest < ActionController::TestCase
  ...
  test "should create tipomenu" do
    assert_difference('Tipomenu.count') do
      post :create, tipomenu: { codigo: @tipomenu.codigo, description: @tipomenu.description, name: @tipomenu.name }
    end
  ...
  test "should update tipomenu" do
    patch :update, id: @tipomenu, tipomenu: { codigo: @tipomenu.codigo, description: @tipomenu.description, name: @tipomenu.name }
    assert_redirected_to tipomenu_path(assigns(:tipomenu))
  end
